...
create policy "lecture authentifiee imports travaux" on public.import_travaux for select to authenticated using (true);
create policy "lecture authentifiee commandes travaux" on public.travaux_commandes for select to authenticated using (true);
create policy "lecture authentifiee historique travaux" on public.travaux_commandes_historique for select to authenticated using (true);
