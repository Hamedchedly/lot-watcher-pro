...
export default function DashboardMap({ dataHeatmap, money }: { dataHeatmap: [string, number][], money: (v: any) => string }) {
  return (
    <MapContainer center={[48.8566, 2.3522]} zoom={9} style={{ height: '100%', width: '100%' }} zoomControl={false}>
